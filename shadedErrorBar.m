function varargout=shadedErrorBar(x,y,errBar,linewidth,varargin)
...
H = makePlot(x,y,errBar,lineProps,linewidth,transparent,patchSaturation);
...
function H = makePlot(x,y,errBar,lineProps,linewidth,transparent,patchSaturation)
